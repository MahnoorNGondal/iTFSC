...
#' 
#' 
seurat_COVID_Yoshida_epi_subset <- readRDS("/mctp/share/users/gondal/01_scHLA/03_output/COVID_Yoshida/version_01_01_16_23/seurat_COVID_Yoshida_epi_subset.RDS")

#subset_version: 
saveRDS(seurat_COVID_Yoshida_epi_subset_downsample, "/mctp/share/users/gondal/Classes/BIOINF576/covid/seurat_COVID_Yoshida_epi_subset_downsample.RDS")
```
...
Normalization_check(seurat_COVID_Yoshida_epi_subset)
...
## second case study
Rawcount_check(seurat_COVID_Yoshida_epi_subset)
```
...
seurat_COVID_Yoshida_epi_subset_downsample <- Down_sample(seurat_COVID_Yoshida_epi_subset, "disease", 20)
...
Runnin_BITFAM(seurat_COVID_Yoshida_epi_subset_downsample, "/mctp/share/users/gondal/Classes/BIOINF576/covid/BITFAM_activities_res_01.csv")
```
...
BITFAM <- read.csv("/mctp/share/users/gondal/Classes/BIOINF576/covid/BITFAM_activities_res_01.csv", 
         header = TRUE,
         sep = ",")
...
# 
# top10 <- top10[,c(1:2,23)]

BITFAM_T$gene <- rownames(BITFAM_T)

 b <- ggbarplot(BITFAM_T, x = "gene", y = "mean", fill = "lightblue")    + ylab("BITFAM score")  +
 ...
 b
ggsave("/mctp/share/users/gondal/Classes/BIOINF576/covid/venndiagbitfam.png",  width = 10, height= 5)
```
...
# 
# 
# down.sample_data.Dorothea <- SetIdent(down.sample_data.Dorothea, value = down.sample_data.Dorothea@meta.data$disease)
...
Runnin_Dorothea(seurat_COVID_Yoshida_epi_subset_downsample, disease,
              "/mctp/share/users/gondal/Classes/BIOINF576/covid/Dorothea_activities_res_01.csv", 
              "/mctp/share/users/gondal/Classes/BIOINF576/covid/Dorothea_activities_res_01_heatmap.png",
              "/mctp/share/users/gondal/Classes/BIOINF576/covid/")
```
...
exprMat <- readRDS("/mctp/share/users/gondal/Classes/BIOINF576/covid/exprMat.RDS")

viper_scores_df <- readRDS("/mctp/share/users/gondal/Classes/BIOINF576/covid/viper_scores_df.Rds")
## We create a data frame containing the cells and their clusters
CellsClusters <- data.frame(cell = names(Idents(down.sample_data.Dorothea)), 
                            cell_type = as.character(Idents(down.sample_data.Dorothea)),
                            stringsAsFactors = FALSE)
...
png(file="/mctp/share/users/gondal/Classes/BIOINF576/covid/TF_heatmapnew_cluster4.png", width=400, height=1500)
...
GSEAdata$gene_symbol <- NULL
 ...
 saveRDS(gsaResgsea_FC_tab,"/mctp/share/users/gondal/Classes/BIOINF576/covid/gsaResgsea_FC_tab.RDS")
...
Runnin_GSEA(seurat_COVID_Yoshida_epi_subset_downsample, disease, "COVID-19",
              "/mctp/share/users/gondal/Classes/BIOINF576/covid/Dorothea_activities_res_01.csv", 
              "/mctp/share/users/gondal/Classes/BIOINF576/covid/Dorothea_activities_res_01_heatmap.png")
```
...
gsaResgsea_FC_tab <- readRDS("/mctp/share/users/gondal/Classes/BIOINF576/covid/gsaResgsea_FC_tab.RDS")
...
top10_melt <- melt(top10)
 ...
 b <- ggbarplot(top10, x = "Name", y = "Stat (dist.dir)", fill = "lightblue")    + ylab("GSEA stat score")  +
  ...
  guides(fill=guide_legend( title="Sub-groups")) + theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1)) 
 b
ggsave("/mctp/share/users/gondal/Classes/BIOINF576/covid/venndiagramdn.png",  width = 10, height= 5)
```
...
Runnin_SCENIC(seurat_COVID_Yoshida_epi_subset_downsample, 
              "/mctp/share/users/gondal/Classes/BIOINF576/",
...
#   
  BITFAM <- read.csv("/mctp/share/users/gondal/Classes/BIOINF576/covid/BITFAM_activities_res_01.csv", 
         header = TRUE,
         sep = ",")
  seurat_COVID_Yoshida_epi_subset_downsample_md <- seurat_COVID_Yoshida_epi_subset_downsample@meta.data
  seurat_COVID_Yoshida_epi_subset_downsample_md$X <- rownames(seurat_COVID_Yoshida_epi_subset_downsample_md)
  Qian_merged_interest_md_BITFAM <- merge(seurat_COVID_Yoshida_epi_subset_downsample_md,
                                          BITFAM, 
                                          by = "X")
  Qian_merged_interest_md_BITFAM_cancer <- filter(Qian_merged_interest_md_BITFAM, disease == "COVID-19")
  ...
  Dorothea <- read.csv("/mctp/share/users/gondal/Classes/BIOINF576/covid/Dorothea_activities_res_01.csv", 
         header = TRUE,
         sep = ",")
  Qian_merged_interest_md_Dorothea <- merge(seurat_COVID_Yoshida_epi_subset_downsample_md,
                                          Dorothea, 
                                          by = "X")
  Qian_merged_interest_md_Dorothea_cancer <- filter(Qian_merged_interest_md_Dorothea, disease == "COVID-19")   
  Dorothea <- t(Qian_merged_interest_md_Dorothea_cancer)
  Dorothea <- as.data.frame(Dorothea[-c(1:52),])
  ...
  xrepressors <- list(  Dorothea = Dorothea_up_TF,
  BITFAM = BITFAM_up_TF,
  GSEA = GSEA_up_TF
  )
  
  common <- intersect(intersect(Dorothea_up_TF,
                      BITFAM_up_TF),
                      GSEA_up_TF)
...
ggVennDiagram(xrepressors, label_alpha = 0, color = 1, lwd = 0.2, lty = 1 , category.names = c(
                                    "Dorothea",
                                    "BITFAM",
...
ggsave("/mctp/share/users/gondal/Classes/BIOINF576/covid/common8.png", width =8, height=6)
