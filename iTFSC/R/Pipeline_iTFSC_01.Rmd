...
#Qian_merged_interest@assays$RNA@data <- Qian_merged_interest@assays$RNA@counts
```
...
Qian_merged_interest_downsample <- Down_sample(Qian_merged_interest, "CellType_updated", 2)
```
